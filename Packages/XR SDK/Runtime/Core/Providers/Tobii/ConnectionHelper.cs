...
namespace Tobii.XR
{
    ...
    public static class ConnectionHelper
    {
        ...
        private static ConnectResult GetFirstSupportedTracker(IStreamEngineInterop interop, IntPtr apiContext, IList<string> connectedDevices, StreamEngineTracker_Description description, out IntPtr deviceContext, out string deviceUrl)
        {
            ...
            foreach (var connectedDeviceUrl in connectedDevices)
            {
                var connectResult = CreateDeviceContext(interop, connectedDeviceUrl, Interop.tobii_field_of_use_t.TOBII_FIELD_OF_USE_STORE_OR_TRANSFER_FALSE, apiContext, description.License, out deviceContext);
