...
{
    /// <summary>
    /// Overlays a debug view with objects that are visible to G2OM this frame.
    ///
    /// NB: This feature uses Unity GL to render and doesn't correctly render for single pass when using URP 
    /// </summary>
    ...
    public class G2OM_DebugVisualization : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            //_mat.EnableKeyword("STEREO_INSTANCING_ON");
            _mat.EnableKeyword("STEREO_MULTIVIEW_ON");
        ...
        {
            if (_showVisualization == false) return;
